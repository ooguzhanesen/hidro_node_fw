...
#ifndef APPLICATION_USER_LORAWAN_APP_SENSOR_SENSORS_H_
#define APPLICATION_USER_LORAWAN_APP_SENSOR_SENSORS_H_
...
#endif /* APPLICATION_USER_LORAWAN_APP_SENSOR_SENSORS_H_ */
